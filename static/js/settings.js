...
function hydrateSettingsForm() {
	...
	document.getElementById("settings-bottle-type").value =
		getDefaultBottleType();
	document.getElementById("settings-bottle-unit").value =
		getDefaultBottleUnit();
}

function savePreferences() {
	const leftName =
		document.getElementById("settings-left-name").value.trim() ||
		DEFAULT_LEFT_NAME;
	const rightName =
		document.getElementById("settings-right-name").value.trim() ||
		DEFAULT_RIGHT_NAME;
